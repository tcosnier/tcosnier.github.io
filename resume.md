...
* **TCAD simulation of AlGaN/GaN HEMTs** to study local stress effects on device characteristics: 2D process and device simulation (tools: [Synopsys](https://www.synopsys.com/silicon/tcad.html)).
